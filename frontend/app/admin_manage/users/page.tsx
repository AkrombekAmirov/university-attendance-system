...
// --- CREATE USER ---
function UserCreateModal({ isOpen, onClose, onSuccess }: { isOpen: boolean; onClose: () => void; onSuccess: () => void }) {
...
// --- EDIT USER ---
function UserEditModal({ isOpen, onClose, user, onSuccess }: { isOpen: boolean; onClose: () => void; user: User | null; onSuccess: () => void }) {
    const [isSubmitting, setIsSubmitting] = useState(false);
...
function UserAssignmentModal({ isOpen, onClose, user, onSuccess }: { isOpen: boolean; onClose: () => void; user: User | null; onSuccess: () => void }) {
    ...
    return (
        <div className="min-h-screen px-4 py-8 sm:px-6 lg:px-8 space-y-6">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                ...
                <Button onClick={() => setIsCreateOpen(true)} className="bg-emerald-600 hover:bg-emerald-700 w-full sm:w-auto">
