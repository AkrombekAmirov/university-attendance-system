...
export default function LoginPage() {
    ...
    const onSubmit = async (data: LoginForm) => {
        ...
        try {
            ...
            // Save user credentials if rememberMe is checked
            if (data.rememberMe) {
            ...
            >
                ...
                <div className="text-center mb-8">
                    <motion.div
                        ...
                        className="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-br from-indigo-600 to-purple-600 rounded-2xl shadow-lg mb-4"
                    >
                                ...
                                {savedUsers.map((user, index) => (
                                    ...
                                    >
                                        ...
                                        ">
                                            ...
                                            {/* Delete Button */}
                                            <button
                                                onClick={(e) => deleteSavedUser(user.username, e)}
                                                className="
                ...
                <p className="text-center text-sm text-gray-500 mt-6">
                    © 2026 Nazorat tizimi. Barcha huquqlar himoyalangan.
                </p>
            </motion.div>
        </div>
    );
